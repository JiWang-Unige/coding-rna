...
description: "A3.5/B· Re-train verified SOTA baselines under the project's small-sample/screen protocol with randomized initialization and multiple seeds, then predict/evaluate fairly instead of only using published or pretrained SOTA outputs."
---
