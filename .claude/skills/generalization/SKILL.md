---
name: generalization
description: "Ph8· Phase-8 comprehensive evaluation after the primary SOTA has been strictly exceeded. Verifies across 8 dimensions — cross-distribution (species / domain / time), OOD splits, robustness (noise / adversarial / corruption), secondary metrics, computational cost, ablations, failure-case analysis, multi-seed paired statistical test — to claim a robust SOTA rather than a single-split fluke. Use only after /pivot has confirmed the primary metric strictly exceeds SOTA on the full profile."
argument-hint: "<exp_id of the SOTA-exceeding result>"
---
