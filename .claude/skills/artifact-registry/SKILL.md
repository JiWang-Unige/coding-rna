...
description: "*· Initialize and audit the project artifact/directory contract: where scripts, configs, sbatch files, full training states, metric reports, iteration docs, external software outputs, raw/processed data, and manuscript assets must live. Writes docs/16_artifact_registry.md and PROJECT_STRUCTURE.md, creates missing directories, and checks run bundles for misplaced or missing artifacts."
argument-hint: "<optional: audit exp_id/run_id/tool output or initialize project layout>"
---
