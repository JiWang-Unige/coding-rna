...
description: "C2· Convert a mature fixed research idea, raw-data analysis plan, or bioinformatics workflow into an executable DAG with IO contracts, stage scripts, external software calls, QC gates, output locations, and validation checks. Writes docs/13_pipeline_blueprint.md and aligns docs/16_artifact_registry.md. Use when the task is pipeline construction/execution rather than exploratory model iteration."
argument-hint: "<raw data / intended workflow / external tools / final outputs>"
---
