---
name: route-reset
description: "*· Restart, fork, or switch the research route inside the same project without creating a new project. Use when the current path is judged unworkable, when Stage A/B must be rerun from deep research, when moving from Discovery to Publication/Pipeline mode, or when the whole pipeline map in docs/11/03/12/13 must be rewritten with carry-forward evidence."
---
