---
name: note-add
description: "*· Unified durable capture for papers, ideas, notes, metrics, discussion decisions, user preferences, pipeline outputs, and SOTA updates without derailing the running experiment."
---
